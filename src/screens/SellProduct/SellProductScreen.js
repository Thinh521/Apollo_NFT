...
import {CONTRACT_ADDRESSES} from '~/contracts/addresses/AddressApolloNFT';
...
import styles from './SellProduct.styles';

const SellProductScreen = ({route}) => {
  ...
  const onSubmit = async formData => {
    ...
    try {
      ...
      await NFTService.approveNFT(walletProvider, tokenId);

      showMessage({
        message: 'Vui lòng xác nhận giao dịch list NFT trong ví',
        type: 'info',
      });
